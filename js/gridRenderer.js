...
function buildWaveSVG(points, width, height, labels) {
    ...
    return `<svg viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" style="width:100%;height:100%;display:block;">
        <defs>
...
function renderYearGrid(moods, language) {
    ...
    const svg = `<svg viewBox="0 0 296 105" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" style="width:100%;height:100%;display:block;">
        <defs>
            <linearGradient id="${gradId}" x1="0%" y1="0%" x2="100%" y2="0%">
                ${lineGradStops || '<stop offset="0%" stop-color="rgba(80,195,215,0.9)"/>'}
            </linearGradient>
