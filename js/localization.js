...
export const translations = {
    en: {
        ...
        okay: 'Okay',
        down: 'Down',
        reviewPrompt: 'Loving MiAura? You\'ve logged {days} days ✦',
        reviewPrompt2: 'Still loving MiAura? {days} days logged ✦',
    ...
    fr: {
        ...
        okay: 'Correct',
        down: 'Abattu',
        reviewPrompt: 'Vous aimez MiAura? {days} jours enregistrés ✦',
        reviewPrompt2: 'Toujours fan de MiAura? {days} jours enregistrés ✦',
    ...
    pt: {
        ...
        okay: 'Ok',
        down: 'Deprimido',
        reviewPrompt: 'Gostando do MiAura? {days} dias registrados ✦',
        reviewPrompt2: 'Ainda curtindo o MiAura? {days} dias registrados ✦',
    ...
    de: {
        ...
        reviewPrompt: 'MiAura gefällt dir? {days} Tage protokolliert ✦',
        reviewPrompt2: 'Immer noch dabei? {days} Tage protokolliert ✦',
    ...
    sv: {
        ...
        okay: 'Okej',
        down: 'Nedstämd',
        reviewPrompt: 'Gillar du MiAura? {days} dagar loggade ✦',
        reviewPrompt2: 'Gillar du MiAura fortfarande? {days} dagar loggade ✦',
